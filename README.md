...
| [SearXNG](https://github.com/netx421/searchtec) | searchtec by itself | [netx421/searchtec:latest](https://hub.docker.com/r/searxng/searxng) | [Dockerfile](https://github.com/searxng/searxng/blob/master/Dockerfile) |
...
- Get searxng-docker
  ```sh
  cd /usr/local
  git clone https://github.com/netx421/searchtec.git
  cd searxng-docker
  ```
